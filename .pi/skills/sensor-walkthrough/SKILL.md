...
```bash
python3 .pi/skills/sensor-walkthrough/build_session.py
```
...
```bash
python3 .pi/skills/sensor-walkthrough/show_window.py unit_04 tag_36 tag_49 --window 180 891
```
